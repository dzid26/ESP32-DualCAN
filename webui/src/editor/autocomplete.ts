...
const API: BindingDoc[] = [
  ...
  { label: 'can_recv_raw',
    detail: 'can_recv_raw(bus:int) -> list | nil',
    documentation: 'Pop one received frame from the bus, or nil if empty. Returns a list [id, data]: rx[0] = CAN ID, rx[1] = payload bytes.',
