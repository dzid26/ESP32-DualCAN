...
const API: BindingDoc[] = [
  ...
  { label: 'can_recv_raw',
    detail: 'can_recv_raw(bus:int, msg_id:int) -> bytes | nil',
    documentation: 'Read the latest received payload bytes for a CAN ID. Returns nil if no frame received for that ID yet.',
